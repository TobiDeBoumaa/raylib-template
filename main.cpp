...
int main()
{
    ...
    const char *tabLabels[] = {"Controls", "3D-Test", "Tab 3"};
    ...
    while (!WindowShouldClose()) // Detect window close button or ESC key
    {
        ...
        int selectedTab2 = GuiTabBar(Rectangle{0, 0, float(GetScreenWidth()), 20}, tabLabels, tabCount, &selectedTab);
        switch (selectedTab)
        {
        case 0:
            // Draw content for Tab 1
        ...
        case 1:
            ...
            break;
        case 2:
            // Draw content for Tab 3
            if(selectedTab2 != -1)
                std::cout << selectedTab2 << std::endl;
                tabCount--;
            break;
        }
